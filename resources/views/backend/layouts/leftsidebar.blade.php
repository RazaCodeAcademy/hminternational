    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            <ul class="menu-nav">
                ...
                <li class="menu-item menu-item-submenu {{ (Route::currentRouteName() == 'manage-account-types.index' || Route::currentRouteName() == 'manage-account-types.create' || Route::currentRouteName() == 'manage-account-types.edit') ? 'menu-item-open menu-item-here' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="menu-text">{{__('Manage Account Types')}}</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item {{ (Route::currentRouteName() == 'manage-account-types.create') ? 'menu-item-active' : '' }}" aria-haspopup="true">

                                <a href="{{route('manage-account-types.create')}}" class="menu-link">
                            ...
                            <li class="menu-item {{ (Route::currentRouteName() == 'manage-account-types.index' || Route::currentRouteName() == 'manage-account-types.edit') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="{{route('manage-account-types.index')}}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">{{__('List Types')}}</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="menu-item menu-item-submenu {{ (Route::currentRouteName() == 'manage-payment-methods.index' || Route::currentRouteName() == 'manage-payment-methods.create' || Route::currentRouteName() == 'manage-payment-methods.edit') ? 'menu-item-open menu-item-here' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item {{ (Route::currentRouteName() == 'manage-payment-methods.create') ? 'menu-item-active' : '' }}" aria-haspopup="true">

                                <a href="{{route('manage-payment-methods.create')}}" class="menu-link">
                            ...
                            <li class="menu-item {{ (Route::currentRouteName() == 'manage-payment-methods.index' || Route::currentRouteName() == 'subAdminListCandidate' ) ? 'menu-item-active' : '' }}" aria-haspopup="true">

                                <a href="{{route('manage-payment-methods.index')}}" class="menu-link">

                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">{{__('List Methods')}}</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item " aria-haspopup="true">
                                ...
                                @endif
                                    ...
                                    <span class="menu-text">{{__('List Transactions')}}</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                @if ($user->id == 1)
                                    <a href="{{route('manage-withdraw.index')}}" class="menu-link">
